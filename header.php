...
<html lang="eng">
	...
	<script>
	  ...
	  // }(document, 'script', 'facebook-jssdk'));
		...
		// (function() {
	  //   // var ogImage = videos[x-1].src;
	  //   var ogUrl = location.href;
	  //   var ogTitle = unescape(location.hash).replace("#", "");
		// 	var ogImage = "watch/" + location.search.replace("?watch=", "") + "/" + ogTitle;
	  //   var ogMeta = `
	  //   <meta id="ogUrl" 						class="og_fb" property="og:url" content="`+ogUrl+`"/>
	  //   <meta id="ogTitle" 					class="og_fb" property="og:title" content="`+ogTitle+`"/>
	  //   <meta id="ogImage" 					class="og_fb" property="og:image" content="`+ogImage+`"/>
	  //   `
	  //   document.querySelector("head").insertAdjacentHTML("afterbegin", ogMeta);
		// }());
		...
		<div class="content">
			...
			<div id="sideNav" class="sidenav">
					...
					<nav>
						<ul id="playlists">
							<?php
								echo '<li><img class="icons" src="'.$path.'/images/icons/passage-of-time.svg"><a class="listLink" href="'.$path.'?playlist=latest">Latest</a></li>
